package com.minimalism.basic.gateway.core.config.bean;

import com.minimalism.basic.core.abs.bean.AbstractGatewayBean;
import com.minimalism.basic.core.constant.ConfigConstant;
import com.minimalism.basic.core.properties.cors.CorsGatewayProperties;
import com.minimalism.basic.core.properties.cors.CorsProperties;
import com.minimalism.basic.gateway.core.abs.CorsFilter;
import com.minimalism.basic.gateway.core.abs.GatewayDistinctResponseHeaderFilter;
import com.minimalism.basic.gateway.core.abs.GatewayDomainsHeaderFilter;
import com.minimalism.basic.gateway.core.abs.GatewayHttpsToHttpFilter;
import com.minimalism.basic.gateway.core.filter.SimpleCorsHeaderFilter;
import com.minimalism.basic.gateway.core.filter.SimpleDistinctResponseHeaderFilter;
import com.minimalism.basic.gateway.core.filter.SimpleDomainsHeaderFilter;
import com.minimalism.basic.gateway.core.filter.SimpleHttpsToHttpFilter;
