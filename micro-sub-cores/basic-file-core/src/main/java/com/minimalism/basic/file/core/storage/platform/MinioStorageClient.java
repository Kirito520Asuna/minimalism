package com.minimalism.basic.file.core.storage.platform;

import cn.hutool.core.util.StrUtil;
import com.minimalism.basic.constant.Constants;
import com.minimalism.basic.core.config.os.OSConfig;
import com.minimalism.basic.core.utils.io.IoUtils;
import com.minimalism.basic.enums.OSType;
import com.minimalism.basic.exceptions.GlobalConfigException;
import com.minimalism.basic.file.core.properties.FileProperties;
import com.minimalism.basic.file.core.storage.StorageType;
import com.minimalism.basic.file.core.utils.oss.MinioOSSUtils;
...
@AllArgsConstructor
@NoArgsConstructor
public class MinioStorageClient implements com.minimalism.basic.file.core.storage.clientAbs.MinioClient {
    ...
    public FileInfo upload(String bucketName, String fileName, InputStream inputStream) {
        com.minimalism.basic.file.core.storage.clientAbs.MinioClient.super.upload(bucketName, fileName, inputStream);
        if (StrUtil.isBlank(bucketName)) {
            bucketName = getBucket();
        }
    ...
    public FileInfo uploadSharding(String bucketName, String fileName, InputStream inputStream, String identifier) {
        com.minimalism.basic.file.core.storage.clientAbs.MinioClient.super.uploadSharding(bucketName, fileName, inputStream, identifier);
        if (StrUtil.isBlank(bucketName)) {
            bucketName = getBucket();
        }
