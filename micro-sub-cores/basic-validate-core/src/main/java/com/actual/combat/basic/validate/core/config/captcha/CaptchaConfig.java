package com.actual.combat.basic.validate.core.config.captcha;
...
public class CaptchaConfig implements AbsBean {
    ...
    @Bean(name = CaptchaConfig.CAPTCHA_PRODUCER_MATH)
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.actual.combat.config.cha.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
