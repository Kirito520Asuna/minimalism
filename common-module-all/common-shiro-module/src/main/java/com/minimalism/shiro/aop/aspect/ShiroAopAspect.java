...
import com.minimalism.shiro.abs.AbsShiroAopAspect;
...
public class ShiroAopAspect implements AbsShiroAopAspect {
    @Override
    @Pointcut(value = "com.minimalism.shiro.aop.aspect.ShiroPermissionsAspect.Aop()||com.minimalism.shiro.aop.aspect.ShiroRolesAspect.Aop()")
    public void Aop() {
    }
