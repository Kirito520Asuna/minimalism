package com.minimalism.common_code.abs;
...
import com.minimalism.common_code.abs.service.AbstractApiSaltService;
import com.minimalism.common_code.config.ApiConfig;
import com.minimalism.base.enums.ApiCode;
import com.minimalism.base.enums.Openfeign;
import com.minimalism.base.exception.GlobalCustomException;
import com.minimalism.common_code.pojo.SaltInfo;
...
import com.minimalism.base.utils.api.ApiUtil;
import com.minimalism.base.utils.date.DateUtils;
import com.minimalism.base.utils.api.SingleSignature;
...
public interface AbsApiSign extends AbsBean {
    ...
    default boolean verifySign(HttpServletRequest request, String signAsName, String salt, String serviceName, String url, Collection<String> exCollection) {
        ...
        if (enableKeyPairs) {
            debug("已启用对称加解密");
            //获取唯一身份id
            String identity = request.getParameter("X-KeyPairs-Identity");
