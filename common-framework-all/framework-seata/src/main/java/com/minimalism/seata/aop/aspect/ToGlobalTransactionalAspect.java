package com.minimalism.seata.aop.aspect;

import cn.hutool.extra.spring.SpringUtil;
import com.minimalism.seata.aop.annotation.ToGlobal;
import com.minimalism.seata.properties.CustomSeataProperties;
...
/*
    ...
    public Object aroundTransactional(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (null == toGlobal) {
            //全局配置
            try {
                CustomSeataProperties properties = SpringUtil.getBean(CustomSeataProperties.class);
