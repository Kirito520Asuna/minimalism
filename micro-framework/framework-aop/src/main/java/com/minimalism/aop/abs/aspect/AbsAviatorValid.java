...
import com.minimalism.aop.all.aviator.*;
import com.minimalism.aop.utils.object.AopObjectUtils;
...
public interface AbsAviatorValid extends AbsAop {
     ...
     */
    @Override
    @Pointcut(value = "@annotation(com.minimalism.aop.all.aviator.AviatorValids)"
            + " || @annotation(com.minimalism.aop.all.aviator.AviatorValid) "
            + " || @annotation(com.minimalism.aop.all.aviator.AviatorNotBlank) "
            + " || @annotation(com.minimalism.aop.all.aviator.Aviator) "
    )
    default void Aop() {
    }
