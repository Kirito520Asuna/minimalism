package com.actual.combat.aop.utils.object;
 ...
 * @Description
 */
public class AopObjectUtils extends ObjectUtil{
    ...
    public static Map<String, Object> toMap(Map<String, Object> map, Object obj, String prx, Integer level) {
        ...
        map = defaultIfNull(map, new LinkedHashMap<>());
        level = defaultIfNull(level, 0);
    ...
    public static Map<String, Object> blankReplace(Map<String, Object> objMap) {
        objMap = defaultIfEmpty(objMap, Maps.newLinkedHashMap());
        for (Map.Entry<String, Object> entry : objMap.entrySet()) {
            String key = entry.getKey();
            Object value = entry.getValue();
            if (equals(StrUtil.EMPTY, value)) {
                objMap.put(key, "''");
            }
        }
        return objMap;
